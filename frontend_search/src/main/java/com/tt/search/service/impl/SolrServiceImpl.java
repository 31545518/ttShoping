package com.tt.search.service.impl;

import com.tt.mapper.SolrItemMapper;
import com.tt.pojo.SolrItem;
 ...
 * @Auther: blackcat
 * @Date: 2020-02-28
 * @Description: com.tt.search.service.impl
 * @version:
 */
@Service
public class SolrServiceImpl implements SolrService {
    ...
    public Result importAll() {
        ...
        try {
            //查询数据
            List<SolrItem> list
                    = this.solrItemMapper.getItemList();
            // 将数据添加到索引库
    ...
    public List<SolrDocument> selectByQ(String q, Long page, Integer pageSize) {
        ...
        highlightOptions.setSimplePrefix("<em style='color:red'>");// 设置高亮样式前缀
